...
## Acidni-Specific Context

When working on Acidni/Terprint Azure infrastructure:

- **Subscription**: `bb40fccf-9ffa-4bad-b9c0-ea40e326882c`
- **Tenant**: `3278dcb1-0a18-42e7-8acf-d3b5f8ae33cd`
- **Key Resource Groups**: See `copilot-instructions.md` for full list
- **Compute**: Azure Functions Consumption Plan (Linux)
- **Identity**: Entra ID with managed identities (never API keys)
- **Secrets**: Azure Key Vault (`acidni-keyvault`, `kv-terprint`)
- **API Management**: `apim-terprint-dev`
- **Database**: Azure Event House (Kusto/KQL) for analytics, Azure SQL for marketplace
